...
const Cart = ({ cartItems, AddCart, deleteFromCart, removeFromCart }) => {
          ...
          return (
            <div  className="cart-row">
              ...
              <div className="cart-item-qty">
                <div>
                <button onClick={() => AddCart(item)} className="qty-buttonii">
                  +
                </button>
                </div>
                <div>
                ...
                <div>
                <button onClick={() => deleteFromCart(item)} className="qty-buttonii">
                  -
                </button>
                </div>
              </div>
